...
#   はいずれも modules/impl-pipeline.sh が定義する。呼び出し元（Slot Runner _slot_run_issue /
#   design 分岐 / 各 gate からの mark_issue_failed・mark_issue_needs_decisions 起動）は
#   実行順序温存のため本体残置。bash の遅延束縛のため順序問題なし。
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# Phase C Slot Runner ヘルパー群 — modules/slot-worker.sh へ切り出し済み（#466）
#   dispatcher_log / dispatcher_warn / dispatcher_error / pclp_log / pclp_warn / pclp_error /
#   check_existing_impl_pr / check_open_design_pr / _parallel_validate_slots / slot_log /
#   slot_warn / slot_error / _slot_mark_failed / _resume_normalize_flag /
...
#   _resume_branch_assert_slug_match / publish_claude_review_status（計 24）は
#   modules/slot-worker.sh が定義する。
#   `_slot_run_issue` 本体（下記）は次 issue #467 で本体から modules/slot-worker.sh へ
#   移動完了予定のため、現時点では本体側に残置する。
#   呼び出し元（Dispatcher = 本体最終盤 / _slot_run_issue 内の各ヘルパー呼び出し）は
#   実行順序温存のため本体残置。bash の遅延束縛のため順序問題なし。
#   詳細: docs/specs/16-phase-c-worktree-slot-dispatcher/design.md
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
